// si cree un directorio con mkdir y le puse mal el nombre, cambiar con mv nombremalo(espacio)nombrebueno
// escribiendo en terminal head nombre archivo puedo ver si el archivo (books.js) está bien guardado

const booksFile = require('./books.json')

//console.log(JSON.stringify(books, null, 2))//me permite imprimir un objeto literal, sirve para debuggear.  El número (2) son los espacios de indentación
//buscar libros por nombres
//esta es la forma imperativa
function getBooksByName(name){
	const foundBooks = []   //agregar nombres de libros parecidos
...
//Lodash https://lodash.com/ (buscar cómo usar y para qué puede servir)
//Modulo fs (file system, modificar el archivo) /buscar
